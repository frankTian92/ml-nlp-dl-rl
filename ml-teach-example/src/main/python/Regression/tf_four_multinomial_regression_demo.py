...
# 参数
learning_rate = 0.00000000000005
...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs):
        ...
        if (epoch + 1) % display_step == 0:
            ...
            print("Epoch : ", "%04d" % (epoch + 1), "loss = ", "{:.9f}".format(c),
                  "W_1 = ", weight_1, "W_2 = ", weight_2, "W_3 = ", weight_3, "W_4 = ", weight_4, " b = ", bias)

    print("Optimization Finished!")
    w_1, w_2, w_3, w_4, b_ = sess.run([W_1, W_2, W_3, W_4, b])
    training_loss = sess.run(loss, feed_dict={X: train_X, Y: train_Y})
    print("Training loss = ", training_loss, "W_1 = ", w_1, "W_2 = ", w_2, "W_3 = ", w_3, "W_4 = ", w_4, "b = ", b_,
          "\n")
    ...
    plt.plot(train_X, w_4 * numpy.power(train_X, 4) + w_3 * numpy.power(train_X, 3)
